(ns threading-macros.core
  ...
  (:require
    hiccups.runtime
    [threading-macros.dom :refer [set-html! show-el! hide-el!]]
    [threading-macros.util :refer [half js-log log one? twice]]))
...
(hiccups/defhtml page-shell []
  [:div.wrapper-614a2
    [:div#top.top-e1133 (dropdown)]
    [:div#bigScreen.big-screen-39c87]
    [:div#buttonsContainer.buttons-38e39]
    [:div#stepsContainer.steps-4fe74]])
